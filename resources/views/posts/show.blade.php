<x-app-layout>
    <div class="bg-zinc-200">
        ...
        <div class="m-auto w-1/3 justify-center  p-8 bg-white">
            ...
            <div class="flex items-center justify-center">
                <img class="items-center m-4 ml-4 " src="{{ asset('storage/' . $post->img_path) }}"
                    alt="illustration du post" class="rounded shadow aspect-auto object-cover object-center" />
            </div>
        ...
        <div class="mt-8">
            ...
            @else
                <div class="flex bg-white  shadow p-4 text-gray-700 justify-between items-center">
                    ...
                    <a href="{{ route('login') }}"
                        class="font-bold bg-white text-gray-700 px-4 py-2 rounded shadow-md">Se
                        connecter</a>
                </div>
            @endauth
        </div>
